import { ChevronRight, Quote, Star, Users, Target, TrendingUp, Play } from "lucide-react"
            ...
            <form className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    className="w-full rounded border border-zinc-700 bg-zinc-800 px-3 py-2 text-white placeholder:text-zinc-500 focus:border-[#00A291] focus:outline-none focus:ring-1 focus:ring-[#00A291]"
                    required
                  />
                </div>
                <div className="space-y-2">
